...
namespace AStarTests {
    ...
    public class GridPlaceTests {
        ...
        GridPlace gridPlaceBase1 = new((-3, 5), _gridPlaceGraph1);
        GridPlace gridPlaceDiag1 = new((-4, 6), _gridPlaceGraph1);
        GridPlace gridPlaceStra1 = new((-3, 6), _gridPlaceGraph1);
        GridPlace gridPlaceDistant1 = new((-60, 60), _gridPlaceGraph1);

        GridPlace gridPlaceBase2 = new((-3, 5), _gridPlaceGraph2);
        GridPlace gridPlaceDiag2 = new((-4, 6), _gridPlaceGraph2);
        GridPlace gridPlaceStra2 = new((-3, 6), _gridPlaceGraph2);
